...
Мы создаем 2D-игру в сеттинге fantasy, цель которой — побеждать в дуэлях против живых людей, а также побеждать в схватках против монстров, которые с каждым раундом становятся всё сильнее. 
Содержание
1.	Общая концепция
1.1.	Цели и задачи
1.2.	Концепция
...
Состав лобби:
То же самое, что лобби, с одним отличием - Дверь закрыта.
