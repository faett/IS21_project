...
Оглавление:
    ...
    5.Требования к интерфейсу
		...
		5.3 Меню Начать игру (делаю сейчас) 
...
Худ игрока - интерфейс отображающийся на экране пользователя.
...
5. Требования к экранам приложения
    4.1. Стартовый экран
    ...
    4.4 Экран меню/лобби
        ...
        4.4.2. Визуальное оформление
            ...
            * Магазин классов:
                ...
                * Npc - старый человек, с седой бородой, в колпаке.
            * Дверь:
        ...
        4.4.3. Функциональные требования меню
            ...
            * Герой не может выйти за пределы видимого экрана.
