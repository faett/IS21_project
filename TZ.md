   ...
   4.Требования к экранам приложения
    ...
    5.Требования к интерфейсу
        ...
        5.3. Меню начать игру
            ...
            * При нажатии кнопки создать, должно быть создано лобби (по выбранным настройкам), хост перемещается в созданное лобби, лобби начинает отображаться в списке доступных лобби для других игроков.
